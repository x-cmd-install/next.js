...
合计: **1,350,624** 行代码（覆盖前 5 种语言、共 **25410** 个文件）。
...
- **最新版本**: `v16.4.0-canary.26` (2026-08-31)
- **最近提交**: 2026-09-10

## 流行度

- **Star**: 142,224 · **Fork**: 31,905 · **开放 issue**: 25,359 · **贡献者**: 3,896

## 累计统计

- **发布数**: 3843 · **已合并 PR**: 28564 · **开放 PR**: 2328 · **已关闭 issue**: 24349 · **开放 issue**: 1010 · **提交数**: 35619
...
_数据快照: `data/card/260911.yml` · 2026-09-11T00:27:40Z._
